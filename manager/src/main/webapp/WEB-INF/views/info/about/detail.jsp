		...
		<div class="box information-management-edit">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row row-list"
						<c:choose>
							<c:when test="${not empty news.type and 'WL' eq news.type}">
								style="display:block;"
							</c:when>
							<c:otherwise>
								style="display:none;"
					...
					>
				  		...
				  		<div class="col-md-8">
				  			<input type="text" name="url" value="${news.url }" readonly="readonly" />
				  		</div>
				  	</div>

					<div class="row row-list"
						<c:choose>
							<c:when test="${not empty news.type and 'ZB' eq news.type}">
								style="display:block;"
							</c:when>
							<c:otherwise>
								style="display:none;"
