...
<div id="app-main-container" class="white-bg">
	<div class="col-md-12">
		<div class="box information-management-edit">
			...
			<h2>${empty publication.id ? "新增" : "编辑" }出版物</h2>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row row-list">
							...
							<div class="col-md-8">
								<input name="pubName" type="text" class="form-control {required:true, maxlength:500, messages:{required:'请输入出版物名称', maxlength:'出版物名称的最大长度为500字符'}}" placeholder="出版物名称" value="${publication.pubName }">
							</div>
						</div>
						...
						<div class="row row-list">
							...
							<div class="col-md-8">
								...
								<!-- hidden -->
								<input type="hidden" id="pubImgUrl" name="pubImgUrl" value="${publication.pubImgUrl }" />

								<span class="tips-text">（750px*255px 200K以内）</span>

								<span id="imgPathTips" class="error" style="display:none;">图片必须上传，请确认</span><br>
								<!-- 回显图片 -->
								<c:choose>
									<c:when test="${not empty publication.pubImgUrl }">
										<img id="imgPathView" src="${publication.pubImgUrl }" alt="" style="width:75px;height:77px;">
									</c:when>
									<c:otherwise>
