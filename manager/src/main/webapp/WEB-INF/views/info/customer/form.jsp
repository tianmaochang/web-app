...
<div id="app-main-container" class="white-bg">
	<div class="col-md-12">
		<div class="box information-management-edit">
			...
			<h2>${empty customer.id ? "新增" : "编辑" }客户信息</h2>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row row-list">
						...
						<div class="col-md-8">
							<input name="cusName" type="text" class="form-control {required:true, maxlength:500, messages:{required:'请输入客户名称', maxlength:'客户名称的最大长度为500字符'}}" placeholder="客户名称" value="${customer.cusName }">
						</div>
					</div>
					...
					<div class="row row-list">
						...
						<div class="col-md-8">
							...
							<!-- hidden -->
							<input type="hidden" id="cusImgUrl" name="cusImgUrl" value="${customer.cusImgUrl }" />
							...
							<c:choose>
								<c:when test="${not empty customer.cusImgUrl }">
									<img id="imgPathView" src="${customer.cusImgUrl }" alt="" style="width:75px;height:77px;">
								</c:when>
								<c:otherwise>
